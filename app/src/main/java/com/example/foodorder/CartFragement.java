 ...
 * Use the {@link CartFragement#newInstance} factory method to
...
public class CartFragement extends Fragment {
    ...
    public static CartFragement newInstance(String param1, String param2) {
        CartFragement fragment = new CartFragement();
